...
docker logs 2282f6464c85


http://bf6c8343f641:8888/lab?token=b1911178757846153770d84384f4f86a74857426b4c40459
http://127.0.0.1:8888/lab?token=6a3fbfcb356bd7e26664157661fdcd57cc531a0a0a86d1e1
```
...
```bash
pyspark
df = spark.read.csv("/data/storage/E-Commerce/Categoria.csv" , header=True, inferSchema=True)
df.show()
```


```bash
spark-submit "/data/resources/01.Teste Spark/teste_spark.py"
```
